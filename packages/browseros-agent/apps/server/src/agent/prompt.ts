...
You do not have a filesystem workspace in this session. Return all results directly in chat. If the user needs file output, suggest they select a working directory from the chat UI.`
  ...
  if (options?.isScheduledTask) {
    ...
    role +=
      '\n\nYou are in NovaClaw mode. Operate as a high-agency browser operator: search, compare, plan, execute, and finish complex tasks through BrowserOS. Prefer browser tools and connected integrations to complete outcomes, not just answer questions.'
